...
then(function(users) {
    ...
    _.forEach(users, function(user) {
        ...
        logger.info(
            user.instagram.username + ": address.postcode type changed to " + Type.string(user.address.postcode));
...
then(function(users) {
    ...
    _.forEach(users, function(user) {
        ...
        logger.info(
            user.instagram.username + ": signupCompletedOn type changed to " + Type.string(user.signupCompletedOn));
