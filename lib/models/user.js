...
function User() {
    ...
    UserSchema.index({'jobs.instagram.nextRunOn': 1, 'jobs.instagram.inQueue': 1, 'active': 1});
    UserSchema.index({'jobs.printing.nextRunOn': 1, 'jobs.printing.inQueue': 1, 'active': 1});
